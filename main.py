...
# Output paths
OUTPUT_DIR = sys.argv[2] if len(sys.argv) > 2 else '/home/bbrundayogananda/projects/cv/results/testv11_640'
...
submission_df.to_csv('submission_v11_640.csv', index=False)
print("Main submission file created: submission_v11_640.csv")
...
high_conf_df.to_csv('submission_v11_high_conf_640.csv', index=False)
print(f"Created high confidence submission with {len(high_conf_df)} predictions")

print("\n=== Pipeline Completed Successfully! ===")
print("Submission files created:")
print("  - submission_v11_640.csv (main submission)")
print("  - submission_v11_high_conf_640.csv (alternative with higher confidence threshold)")
